...
{
    /// <summary>
    /// Wrapper class to apply an <see cref="LowpassFilter"/> to a given
    ...
    public class LowpassFilterWrapper(ISampleSource inputSource) : ISampleSource
    {
        private readonly ISampleSource source = inputSource;
        private readonly LowpassFilter filter = new(inputSource.WaveFormat.SampleRate, 3000);
